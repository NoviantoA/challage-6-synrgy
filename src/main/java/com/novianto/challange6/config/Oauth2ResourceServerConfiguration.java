...
@EnableGlobalMethodSecurity(securedEnabled = true) //securedefinition
    ...
    public void configure(HttpSecurity http) throws Exception {
        http.cors()
                ...
                .antMatchers("/", "/showFile/**", "/v1/showFile/**", "/v1/upload",
                        "/user-register/**", "/swagger-ui/**", "/swagger-ui.html", "/v3/api-docs/**", "/user-login/**", "/forget-password/**", "/oauth/authorize**", "/login**", "/error**")
                .permitAll()
